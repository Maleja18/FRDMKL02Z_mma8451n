...
void BOARD_LedPin(void)
{
    ...
    GPIO_PinInit(BOARD_LEDPIN_LED_RED_GPIO, BOARD_LEDPIN_LED_RED_PIN, &LED_RED_config);
    ...
    GPIO_PinInit(BOARD_LEDPIN_LED_GREEN_GPIO, BOARD_LEDPIN_LED_GREEN_PIN, &LED_GREEN_config);
    ...
    GPIO_PinInit(BOARD_LEDPIN_LED_BLUE_GPIO, BOARD_LEDPIN_LED_BLUE_PIN, &LED_BLUE_config);

    /* PORTB10 (pin 13) is configured as PTB10 */
    PORT_SetPinMux(BOARD_LEDPIN_LED_BLUE_PORT, BOARD_LEDPIN_LED_BLUE_PIN, kPORT_MuxAsGpio);

    /* PORTB6 (pin 1) is configured as PTB6 */
    PORT_SetPinMux(BOARD_LEDPIN_LED_RED_PORT, BOARD_LEDPIN_LED_RED_PIN, kPORT_MuxAsGpio);

    /* PORTB7 (pin 2) is configured as PTB7 */
    PORT_SetPinMux(BOARD_LEDPIN_LED_GREEN_PORT, BOARD_LEDPIN_LED_GREEN_PIN, kPORT_MuxAsGpio);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
